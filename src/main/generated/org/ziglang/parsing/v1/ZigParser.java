...
public class ZigParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ADDITION_EXPR, ANON_STRUCT_EXPR, ARRAY_EXPR, ASM_EXPR,
      ...
      STRING, STRUCT_ENUM_ACCESS_EXPR, SUFFIX_OP_EXPR, SYMBOL,
      TRY_EXPR, TYPE_EXPR, UNWRAP_EXPR),
  };

  /* ********************************************************** */
  // CALLCONV_KEYWORD LEFT_PAREN expr RIGHT_PAREN
  public static boolean CallConv(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "CallConv")) return false;
    if (!nextTokenIs(builder_, CALLCONV_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, CALLCONV_KEYWORD, LEFT_PAREN);
  ...
  /* ********************************************************** */
  // LINKSECTION_KEYWORD LEFT_PAREN expr RIGHT_PAREN
  public static boolean LinkSection(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, LINKSECTION_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, LINKSECTION_KEYWORD, LEFT_PAREN);
    result_ = result_ && expr(builder_, level_ + 1, -1);
    result_ = result_ && consumeToken(builder_, RIGHT_PAREN);
  ...
  private static boolean asmOutputItem_5_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && expr(builder_, level_ + 1, 20);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  private static boolean containerField_1_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, COLON_SYM);
    result_ = result_ && expr(builder_, level_ + 1, 24);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // (OPAQUE_KEYWORD)? LEFT_BRACE (containerInitBody COMMA_SYM?)? RIGHT_BRACE
  public static boolean containerInitSuffix(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<container init suffix>", LEFT_BRACE, OPAQUE_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, CONTAINER_INIT_SUFFIX, "<container init suffix>");
    result_ = containerInitSuffix_0(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, LEFT_BRACE);
    result_ = result_ && containerInitSuffix_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RIGHT_BRACE);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  // (OPAQUE_KEYWORD)?
  private static boolean containerInitSuffix_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "containerInitSuffix_0")) return false;
    consumeToken(builder_, OPAQUE_KEYWORD);
    return true;
  }

  // (containerInitBody COMMA_SYM?)?
  private static boolean containerInitSuffix_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "containerInitSuffix_2")) return false;
    containerInitSuffix_2_0(builder_, level_ + 1);
    return true;
  }

  // containerInitBody COMMA_SYM?
  private static boolean containerInitSuffix_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "containerInitSuffix_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = containerInitBody(builder_, level_ + 1);
    result_ = result_ && containerInitSuffix_2_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // COMMA_SYM?
  private static boolean containerInitSuffix_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "containerInitSuffix_2_0_1")) return false;
  ...
  /* ********************************************************** */
  // PUB_KEYWORD? ((INLINE_KEYWORD | NOINLINE_KEYWORD) | EXPORT_KEYWORD)?
  //   fnProto block
  ...
  // ((INLINE_KEYWORD | NOINLINE_KEYWORD) | EXPORT_KEYWORD)?
  ...
  private static boolean fnDeclaration_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = fnDeclaration_1_0_0(builder_, level_ + 1);
  ...
  private static boolean fnDeclaration_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "fnDeclaration_1_0_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, INLINE_KEYWORD);
    if (!result_) result_ = consumeToken(builder_, NOINLINE_KEYWORD);
    return result_;
  }
  ...
  /* ********************************************************** */
  // PUB_KEYWORD? EXPORT_KEYWORD? THREADLOCAL_KEYWORD?
  //   variableDeclaration
  //  SEMICOLON_SYM
  public static boolean globalVarDeclaration(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && globalVarDeclaration_2(builder_, level_ + 1);
  ...
  private static boolean globalVarDeclaration_2(PsiBuilder builder_, int level_) {
    ...
    consumeToken(builder_, THREADLOCAL_KEYWORD);
    return true;
  }
  ...
  public static boolean namespaceDeclaration(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, USINGNAMESPACE_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, USINGNAMESPACE_KEYWORD);
    result_ = result_ && expr(builder_, level_ + 1, -1);
  ...
  //  (symbol COLON_SYM)?
  //  (typeExpr | VAR_KEYWORD | RANGE_SYM | ANYTYPE_KEYWORD)
  ...
  private static boolean paramDeclaration_2(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeToken(builder_, ANYTYPE_KEYWORD);
    return result_;
  }
  ...
  //  )? CONST_KEYWORD? VOLATILE_KEYWORD? ALLOWZERO_KEYWORD?
  //  | QUESTION_SYM
  //  | VERY_QUESTION_SYM
  //  | MINUS_MOD_SYM
  //  | TRY_KEYWORD
  //  | AWAIT_KEYWORD
  //  | ANYFRAME_KEYWORD SMALL_ARROW_SYM
  public static boolean prefixOp(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = parseTokens(builder_, 0, ANYFRAME_KEYWORD, SMALL_ARROW_SYM);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean prefixOp_4(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && prefixOp_4_4(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // ALLOWZERO_KEYWORD?
  private static boolean prefixOp_4_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "prefixOp_4_4")) return false;
    consumeToken(builder_, ALLOWZERO_KEYWORD);
    return true;
  }
  ...
  /* ********************************************************** */
  // (SUSPEND_KEYWORD | NOSUSPEND_KEYWORD) (SEP_SYM symbol SEP_SYM block)?
  public static boolean suspendBlock(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<suspend block>", NOSUSPEND_KEYWORD, SUSPEND_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, SUSPEND_BLOCK, "<suspend block>");
    result_ = suspendBlock_0(builder_, level_ + 1);
    result_ = result_ && suspendBlock_1(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // SUSPEND_KEYWORD | NOSUSPEND_KEYWORD
  private static boolean suspendBlock_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suspendBlock_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, SUSPEND_KEYWORD);
    if (!result_) result_ = consumeToken(builder_, NOSUSPEND_KEYWORD);
    return result_;
  }
  ...
  /* ********************************************************** */
  // (SUSPEND_KEYWORD | NOSUSPEND_KEYWORD) (SEP_SYM symbol SEP_SYM exprOrBlock)?
  public static boolean suspendExprOrBlock(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, "<suspend expr or block>", NOSUSPEND_KEYWORD, SUSPEND_KEYWORD)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, SUSPEND_EXPR_OR_BLOCK, "<suspend expr or block>");
    result_ = suspendExprOrBlock_0(builder_, level_ + 1);
  ...
  // SUSPEND_KEYWORD | NOSUSPEND_KEYWORD
  private static boolean suspendExprOrBlock_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suspendExprOrBlock_0")) return false;
    boolean result_;
    result_ = consumeToken(builder_, SUSPEND_KEYWORD);
    if (!result_) result_ = consumeToken(builder_, NOSUSPEND_KEYWORD);
    return result_;
  ...
  private static boolean variableDeclaration_2_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    result_ = expr(builder_, level_ + 1, 20);
    if (!result_) result_ = expr(builder_, level_ + 1, 24);
    return result_;
  }
  ...
  // 18: ATOM(anonStructExpr)
  // 19: PREFIX(structEnumAccessExpr)
  // 20: POSTFIX(curlySuffixExpr)
  // 21: BINARY(typeExpr)
  // 22: PREFIX(prefixOpExpr)
  // 23: POSTFIX(suffixOpExpr)
  // 24: ATOM(asyncExpr)
  // 25: ATOM(integer) ATOM(float) ATOM(string) ATOM(char)
  ...
  public static boolean expr(PsiBuilder builder_, int level_, int priority_) {
    ...
    if (!result_) result_ = anonStructExpr(builder_, level_ + 1);
    if (!result_) result_ = structEnumAccessExpr(builder_, level_ + 1);
  ...
  public static boolean expr_0(PsiBuilder builder_, int level_, int priority_) {
    ...
    while (true) {
      ...
      else if (priority_ < 20 && containerInitSuffix(builder_, level_ + 1)) {
        result_ = true;
        exit_section_(builder_, level_, marker_, CURLY_SUFFIX_EXPR, result_, true, null);
      }
      else if (priority_ < 21 && consumeTokenSmart(builder_, NOT_SYM)) {
        result_ = expr(builder_, level_, 21);
        exit_section_(builder_, level_, marker_, TYPE_EXPR, result_, true, null);
      }
      else if (priority_ < 23 && suffixOpExpr_0(builder_, level_ + 1)) {
        result_ = true;
  ...
  // DOT_SYM containerInitSuffix
  public static boolean anonStructExpr(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "anonStructExpr")) return false;
    if (!nextTokenIsSmart(builder_, DOT_SYM)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokenSmart(builder_, DOT_SYM);
    result_ = result_ && containerInitSuffix(builder_, level_ + 1);
    exit_section_(builder_, marker_, ANON_STRUCT_EXPR, result_);
    return result_;
  }

  public static boolean structEnumAccessExpr(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "structEnumAccessExpr")) return false;
    if (!nextTokenIsSmart(builder_, DOT_SYM)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, null);
    result_ = consumeTokenSmart(builder_, DOT_SYM);
    ...
    exit_section_(builder_, level_, marker_, STRUCT_ENUM_ACCESS_EXPR, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  public static boolean string(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeTokenSmart(builder_, STR_MULTILINE);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  //  CONST_KEYWORD? VOLATILE_KEYWORD? ALLOWZERO_KEYWORD? typeExpr
  public static boolean arrayExpr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && arrayExpr_6(builder_, level_ + 1);
    result_ = result_ && expr(builder_, level_ + 1, 20);
  ...
  // ALLOWZERO_KEYWORD?
  private static boolean arrayExpr_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "arrayExpr_6")) return false;
    consumeTokenSmart(builder_, ALLOWZERO_KEYWORD);
    return true;
  }
  ...
  //  (SECTION_KEYWORD LEFT_PAREN expr RIGHT_PAREN)? LinkSection? CallConv? NOT_SYM? (typeExpr | VAR_KEYWORD)
  public static boolean fnProto(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && fnProto_8(builder_, level_ + 1);
    result_ = result_ && fnProto_9(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  public static boolean asmExpr(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_;
    result_ = pinned_ && expr(builder_, level_, 24);
