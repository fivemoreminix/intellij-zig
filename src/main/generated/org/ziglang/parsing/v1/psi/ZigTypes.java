...
import org.ziglang.parsing.v1.ZigElementType;
import org.ziglang.parsing.v1.ZigTokenType;
import org.ziglang.parsing.v1.psi.impl.*;
...
public interface ZigTypes {
  ...
  IElementType ANON_STRUCT_EXPR = new ZigElementType("ANON_STRUCT_EXPR");
  ...
  IElementType NAMESPACE_DECLARATION = new ZigElementType("NAMESPACE_DECLARATION");
  ...
  IElementType STRUCT_ENUM_ACCESS_EXPR = new ZigElementType("STRUCT_ENUM_ACCESS_EXPR");
  ...
  IElementType STR_MULTILINE = new ZigTokenType("STR_MULTILINE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ADDITION_EXPR) {
      ...
      else if (type == ANON_STRUCT_EXPR) {
        return new ZigAnonStructExprImpl(node);
      }
        ...
        return new ZigNamespaceDeclarationImpl(node);
      }
      else if (type == NULL) {
      ...
      else if (type == STRUCT_ENUM_ACCESS_EXPR) {
        return new ZigStructEnumAccessExprImpl(node);
      }
