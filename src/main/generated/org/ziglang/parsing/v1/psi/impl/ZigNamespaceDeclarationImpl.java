...
public class ZigNamespaceDeclarationImpl extends ASTWrapperPsiElement implements ZigNamespaceDeclaration {

  public ZigNamespaceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
